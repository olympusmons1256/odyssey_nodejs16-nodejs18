...
exports.getTwilioIceServers = void 0;
...
async function getTwilioIceServers() {
    ...
    const client = (0, twilio_1.default)(twilioCredentials.accountSid, twilioCredentials.authToken);
    const tokens = await client.tokens.create();
    return tokens.iceServers.map((v) => v);
}
exports.getTwilioIceServers = getTwilioIceServers;
