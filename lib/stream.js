...
exports.getJwtToken = exports.getStreamKey = void 0;
const functions = __importStar(require("firebase-functions"));
const shared_1 = require("./shared");
const token_1 = require("./lib/stream/token");
exports.getStreamKey = functions
    ...
    try {
        ...
        const consumerKey = (0, token_1.getStreamCredentials)().consumerKey;
...
exports.getJwtToken = functions
    ...
    try {
        ...
        const jwtToken = await (0, token_1.signParticipantJwtToken)(userId);
