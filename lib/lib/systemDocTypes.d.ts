...
export declare type ClusterProvider = "gke" | "coreweave";
export declare type ClusterProviders = ClusterProvider[];
export declare type GkeAccelerator = "nvidia-tesla-t4" | "nvidia-tesla-p100" | "nvidia-tesla-a100" | "nvidia-tesla-p4" | "nvidia-tesla-v100" | "nvidia-tesla-k80";
export interface GkeAcceleratorNodePoolConfiguration {
    accelerator: GkeAccelerator;
    minNodeCount?: number;
}
export declare type CoreweaveCpuAvailability = "high" | "low" | "medium" | "none";
...
export declare type CoreweaveValidGpus = {
    [key: string]: CoreweaveValidGpu;
};
export declare type ExtraNodeSelectorMatchExpressions = {
    [key: string]: string[];
};
...
export declare type CoreweaveRegionsAvailabilityResponseData = CoreweaveRegionAvailability[];
