...
export declare type StripeCheckoutMode = "payment" | "setup" | "subscription";
export declare type PriceType = "base-fee" | "workspace-seats" | "published-spaces";
...
declare type OrganizationUsageResponseAggregation = SumCreditsUsedBySpaceIdAggregationResults;
