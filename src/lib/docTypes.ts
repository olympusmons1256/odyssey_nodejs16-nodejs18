...
export interface Invite {
  created: admin.firestore.Timestamp,
  updated: admin.firestore.Timestamp
  accepted?: admin.firestore.Timestamp
  rejected?: admin.firestore.Timestamp
  email: string,
  role: UserRoles,
  type: "email" | "link",
  authSkip?: boolean,
...
export interface Participant {
  created: admin.firestore.Timestamp
  updated: admin.firestore.Timestamp
  lastUsageCheck?: admin.firestore.Timestamp
  userId: string
  deviceId: string
  bot?: boolean
  afkCheck?: admin.firestore.Timestamp
...
export interface Auth {
  email: string
  uid: string
  providerData: (admin.auth.UserInfo | null)[]
  metaData: {
...
export interface UnrealProjectVersion {
  ...
  lastPingFromBuilder?: admin.firestore.Timestamp
  lastPingFromVolumeCopyRegion?: admin.firestore.Timestamp
